...
begin
  ...
  If FileAge(ORAFlags+LoadParam.FLAG_IS)<>-1 then  { Данная закачка уже производится }
  Begin
    CheckIs:=true;
    Result:=false;
...
begin
  ...
  try
    ...
    Begin
      ...
      NMSMTP1.PostMessage.Body.Text:=ParamStr(0)+CHR(13)+CHR(10)+'Дата и время:' + DateTimeToStr(Now)+CHR(13)+CHR(10)+ErrStr;
