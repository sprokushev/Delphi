...
uses
  ...
  ParusLog in 'ParusLog.pas' {f_ParusLog},
  ...
  MO_SvedNew in 'OTGR\MO_SvedNew.pas' {f_SvedNew},
  MO_VedOsmotr in 'OTGR\MO_VedOsmotr.pas' {f_VedOsmotr},
  MO_VedOsmotrNew in 'OTGR\MO_VedOsmotrNew.pas' {f_VedOsmotrNew},
  MO_nakl in 'OTGR\MO_nakl.pas' {f_Nakl},
  SvedIn in 'OTGR\SvedIn.pas' {f_SvedIn},
  SvedInNew in 'OTGR\SvedInNew.pas' {f_SvedInNew},
  MO_Podacha in 'OTGR\MO_Podacha.pas' {f_Podacha},
  MO_PodachaNew in 'OTGR\MO_PodachaNew.pas' {f_PodachaNew},
  MO_PaspBrowse in 'OTGR\MO_PaspBrowse.pas' {f_PaspBrowse},
  cardHistory in 'AZC\cardHistory.pas' {f_cardHistory},
  MO_SvedAddVagon in 'OTGR\MO_SvedAddVagon.pas' {f_AddVagon},
  MO_PodachaAddVedOsm in 'OTGR\MO_PodachaAddVedOsm.pas' {f_PodachaAddVedOsm},
  SelectableTree in 'SelectableTree.pas' {tree with checkboxes},
  FrameNariad in 'FrameNariad.pas' {frmNariad: TFrame},
  MO_SvedAddress in 'OTGR\MO_SvedAddress.pas' {f_SvedAddress},
  Raspor in 'OTGR\Raspor.pas' {f_Raspor},
  RasporNew in 'OTGR\RasporNew.pas' {f_RasporNew},
  MO_Sved in 'OTGR\MO_Sved.pas' {f_Sved},
  MO_NaklVozNew in 'OTGR\MO_NaklVozNew.pas' {f_NaklVozNew},
  MO_NaklAddVagon in 'OTGR\MO_NaklAddVagon.pas' {f_NaklAddVagon},
  MO_SvedAddVagonVedPod in 'OTGR\MO_SvedAddVagonVedPod.pas' {f_AddVagonVedPod},
  MO_MoveVagon in 'OTGR\MO_MoveVagon.pas' {f_MoveVagon},
  MO_Find in 'OTGR\MO_Find.pas' {f_FindVagon},
  MO_UVED in 'OTGR\MO_UVED.pas' {f_Uved},
  MO_UvedNew in 'OTGR\MO_UvedNew.pas' {f_UvedNew},
  u_moveprod in 'Moveprod\u_moveprod.pas' {f_move},
  MO_Pasp in 'OTGR\MO_Pasp.pas' {f_Pasp},
  MO_TablPok in 'OTGR\MO_TablPok.pas' {f_TablPok},
  MO_PaspAdd in 'OTGR\MO_PaspAdd.pas' {f_PaspAdd},
  u_repvoz in 'Vozvrat\u_repvoz.pas' {f_repvoz},
  oper_pod in 'oper_pod.pas' {f_oper_pod},
  MO_NaklNew in 'OTGR\MO_NaklNew.pas' {f_NaklNew},
  U_history in 'gu12\U_history.pas' {f_history},
  MO_ShabVoz in 'OTGR\MO_ShabVoz.pas' {f_ShabVozNew},
  MO_ShabExp in 'OTGR\MO_ShabExp.pas' {f_ShabExp},
  MO_ShabExpNew in 'OTGR\MO_ShabExpNew.pas' {f_ShabExpNew},
  MO_UvedVozNew in 'OTGR\MO_UvedVozNew.pas' {f_UvedVozNew},
  Export2R3 in 'R3\Export2R3.pas' {f_Export2R3},
  Export2Pererabotka in 'R3\Export2Pererabotka.pas' {f_Export2Pererabotka},
  u_sfload in 'R3\u_sfload.pas' {f_sfload},
  UnitTest in 'UnitTest.pas' {FormTest},
  CustomDBGridEhImpExp in 'R3\CustomDBGridEhImpExp.pas',
  ARCSISDataFormUnit in 'ARCSIS\ARCSISDataFormUnit.pas' {ARCSISDATAFORM},
  ARSCISGetWay in 'ARCSIS\ARSCISGetWay.pas' {f_ARSCISGetWay};
