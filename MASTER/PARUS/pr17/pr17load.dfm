object frmPR17: TfrmPR17
  Left = 177
  Top = 242
  Width = 1081
  Height = 709
  Caption = #1055#1088#1080#1093#1086#1076#1085#1099#1077' '#1086#1088#1076#1077#1088#1072' '#1074' '#1055#1072#1088#1091#1089
  Color = clBtnFace
  ...
  object oraPR17: TOracleDataSet
    SQL.Strings = (
      ...
      ' k.nom_zd, k.id,k.mesto_id,m.date_plan,'
      
        ' pn.MODIF,pn.MOD_MODIF,pr.id as poluch_id,m.stan_id,pn.taxgr_cod' +
        'e,pn.taxgr_income'
      'from kvit k, '
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000016000000030000005645530100000000000200000049440100000000
      ...
      
      5847525F494E434F4D45010000000000}
    ReadOnly = True
    Session = oraMain
    Left = 432
    Top = 176
    ...
    object oraPR17TAXGR_INCOME: TStringField
      FieldName = 'TAXGR_INCOME'
    end
  end
