...
Procedure TfrmTTNd_kos.acFilterExecute(Sender: TObject);
Begin
...
Procedure TfrmTTNd_kos.FormCreate(Sender: TObject);
Begin
  deBeg.Date := date - 2;
  deEnd.Date := date - 1;
...
Procedure TfrmTTNd_kos.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
  oraPR17.Close;
  oraCatalog.Close;
...
Procedure TfrmTTNd_kos.acLoadExecute(Sender: TObject);
Var
  summ                                  : String;
...
Procedure TfrmTTNd_kos.dbgPR17GetCellParams(Sender: TObject;
...
Procedure TfrmTTNd_kos.tvCatalogGetImageIndex(Sender: TObject;
  Node: TTreeNode);
Begin
