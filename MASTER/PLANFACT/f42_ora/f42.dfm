object f_f42: Tf_f42
  ...
  object q_pryam_sf_ora: TOracleDataSet
    SQL.Strings = (
      ...
      '--  AND v_out_plat_dbf.data_buxg<'#39'30-jun-2006'#39
  ...
  object q_fact_plat_ora: TOracleDataSet
    SQL.Strings = (
      'SELECT /*+ RULE*/'
      'v_out_plat_dbf.kod_nfp as kod_npr,'
      'avg(kls_planstru.level_pos) as kod_pos,'
      'kls_planstru.kod_sgr,'
      'kls_planstru.kod_spg,'
      'kls_planstru.kod_rzd,'
      'kls_planstru.kod_prz,'
      'kls_planstru.kod_grp,'
      'max(kls_planstru.name) AS naim,'
      '/*'
      ...
      '  AND v_out_plat_dbf.data_kvit BETWEEN :BEG_DATE AND :END_DATE'
        ...
        'GROUP BY v_out_plat_dbf.kod_nfp,kls_planstru.kod_sgr,kls_planstr' +
        'u.kod_spg,kls_planstru.kod_rzd,kls_planstru.kod_prz,kls_planstru' +
        '.kod_grp'
      'UNION ALL'
      'SELECT'
      ...
      '  AND month.DOG_ID=kls_dog.ID'
        ...
        '8 or kls_dog.predpr_id=8) and'
      '  kvit.date_kvit BETWEEN :BEG_DATE AND :END_DATE'
      
        'GROUP BY kvit.prod_id_npr,kls_planstru.kod_sgr,kls_planstru.kod_' +
        'spg,kls_planstru.kod_rzd,kls_planstru.kod_prz,kls_planstru.kod_g' +
        'rp')
    Variables.Data = {
      0300000002000000090000003A4245475F444154450C00000000000000000000
      00090000003A454E445F444154450C0000000000000000000000}
