object f_Export2R3: Tf_Export2R3
  ...
  object qPasp: TOracleDataSet
    SQL.Strings = (
      ...
      '('
        ...
        'select /*+ RULE */ r3_kvit2sap.ID_SAP, r3_kvit2sap.ID_SAP_PSN,'#39'C' +
        'Q_NUM'#39' as QQ_NAME,kls_pasp.PASP_NUM as QQ_VALUE from kls_pasp,r3' +
        '_kvit2sap,kvit'
      'where kvit.PASP_ID=kls_pasp.ID'
      #9'  and kvit.ID=r3_kvit2sap.KVIT_ID'
      ...
      'union all'
        ...
        'select r3_kvit2sap.ID_SAP as r3_num_post, r3_kvit2sap.ID_SAP_PSN' +
        ' as r3_post_pos,'#39'CQ_INSP_NAME'#39','#39#1051#1059#1050#1054#1049#1051'-'#1059#1053#1055#39' from kls_pasp,kvit,r' +
        '3_kvit2sap'
      'where kvit.PASP_ID=kls_pasp.ID'
      #9'  and kvit.ID=r3_kvit2sap.KVIT_ID'
      ...
      'union all'
        ...
        'select r3_kvit2sap.ID_SAP as r3_num_post, r3_kvit2sap.ID_SAP_PSN' +
        ' as r3_post_pos,'#39'CQ_DATE_INSP'#39',to_char(kls_pasp.PASP_DATE,'#39'dd.mm' +
        '.yyyy'#39')'
      ...
      'union all'
      'select'
      'r3_kvit2sap.ID_SAP as r3_num_post,'
      'r3_kvit2sap.ID_SAP_PSN as r3_post_pos,'
      'kls_kodif.ID_R3,'
      'to_char(kls_valpasp.QUAL)'
      'from kls_pasp,kls_valpasp,kls_kodif,r3_kvit2sap,kvit'
      'where kls_pasp.ID=kls_valpasp.PASP_ID'
      #9'  and kls_valpasp.KODIF_ID=kls_kodif.ID'
      #9'  and kvit.PASP_ID=kls_pasp.ID'
      #9'  and kvit.ID=r3_kvit2sap.KVIT_ID'
  ...
  object qSF: TOracleDataSet
    SQL.Strings = (
      'select /*+ RULE */ '
      '  TO_CHAR(kvit.NUM_KVIT) as LIFEX,--'#1053#1086#1084#1077#1088' '#1087#1086#1089#1090#1072#1074#1082#1080
      '  kvit.NUM_CIST as TRAID,'
  ...
  object qSutRazn: TOracleDataSet
    SQL.Strings = (
      'select /*+ RULE */ '
        ...
        'TO_CHAR(kvit.DATE_KVIT,'#39'YYMMDD'#39')||'#39'/'#39'||kvit.NOM_ZD as NOM_SUT_ZD' +
        ','
      'kvit.DATE_KVIT,'
      ...
      'from kvit,month,kls_dog,kls_prod'
      'where kvit.NOM_ZD=month.NOM_ZD'
      '  and month.dog_id=kls_dog.id'
      ...
      '  AND MONTH.IS_EXP+0=1'
      'GROUP BY'
      'TO_CHAR(kvit.DATE_KVIT,'#39'YYMMDD'#39')||'#39'/'#39'||kvit.NOM_ZD,'
      'kvit.DATE_KVIT,'
