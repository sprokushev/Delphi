...
// PSV: 20.03.2012. Надо сохранять данные расходомеров, поэтому я убрал лишнюю логику
// PSV: 20.03.2012. Ищем только по конкретному ID
...
// 22.03.2012 Алчинов Ю.  VES (чистый вес) должен содержать не более 3-х знаков после запятой
