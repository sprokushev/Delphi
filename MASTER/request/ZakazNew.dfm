object f_ZakazNew: Tf_ZakazNew
    ...
    object TabSheet1: TTabSheet
      ...
      object GroupBox5: TGroupBox
        ...
        object Label37: TLabel
          ...
          Width = 81
          Height = 13
          Caption = #1058#1080#1087' '#1090#1088#1072#1085#1079#1080#1090#1072
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object cbPeriodZakaz: TRxDBLookupCombo
          Left = 146
          Top = 8
          Width = 180
          Height = 21
        ...
        object cbTIP_CORP: TRxDBLookupCombo
          Left = 424
          Top = 8
          Width = 177
          Height = 21
  ...
  object oraPlat: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4D450100000000000B0000005052454450525F4E414D45010000000000030000
      00494E4E010000000000}
    DetailFields = 'id'
  ...
  object oraDog: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      
      0000000000}
    Master = oraPlat
    MasterFields = 'id'
    Session = oraTSes
  ...
  object oraProd: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    QBEDefinition.QBEFieldDefs = {
      04000000030000000600000049445F4E50520100000000000D0000004C4F4E47
  ...
  object oraPayform: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000020000000200000049440100000000000C000000504159464F524D5F
  ...
  object oraVidOtgr: TOracleDataSet
    SQL.Strings = (
      ...
      'order by load_name')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000090000004C4F41445F41424252010000000000090000004C
      4F41445F4E414D45010000000000}
    Session = oraTSes
    Left = 348
    Top = 65535
  ...
  object oraVetka: TOracleDataSet
    SQL.Strings = (
      ...
      'order by vetka_name')
    QBEDefinition.QBEFieldDefs = {
      04000000020000000200000049440100000000000A0000005645544B415F4E41
      4D45010000000000}
    QueryAllRecords = False
    Session = oraTSes
    Left = 644
  ...
  object oraPoluch: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    QBEDefinition.QBEFieldDefs = {
      04000000050000000200000049440100000000000A00000053484F52545F4E41
      4D450100000000000B0000005052454450525F4E414D45010000000000040000
      004F4B504F0100000000000600000047445F4B4F44010000000000}
    QueryAllRecords = False
    Session = oraTSes
    Left = 428
    Top = 1
  ...
  object oraPlanStru: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000009000000524547494F4E5F4944010000000000}
    QueryAllRecords = False
    Session = oraTSes
    Left = 182
    Top = 1
  ...
  object oraLukDog: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000040000000200000049440100000000000A000000444F475F4E554D42
      45520100000000000A00000053484F52545F4E414D4501000000000008000000
      49535F4147454E54010000000000}
    Session = oraTSes
    Left = 621
    Top = 485
  ...
  object oraGosprog: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    QBEDefinition.QBEFieldDefs = {
      04000000020000000200000049440100000000000C000000474F5350524F475F
      4E414D45010000000000}
    QueryAllRecords = False
    Session = oraTSes
    Left = 342
  ...
  object oraPeriod: TOracleDataSet
    SQL.Strings = (
      'select id, name from KLS_ZAKAZ_PERIOD order by id')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000020000004944010000000000040000004E414D4501000000
      0000}
    Session = oraTSes
  ...
  object oraTIP_CORP: TOracleDataSet
    SQL.Strings = (
      'select id, name from KLS_ZAKAZ_TIP_CORP')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000020000004944010000000000040000004E414D4501000000
      0000}
    Session = oraTSes
    Left = 412
    Top = 32
    object oraTIP_CORPID: TFloatField
      FieldName = 'ID'
      Required = True
    end
    object oraTIP_CORPNAME: TStringField
      FieldName = 'NAME'
      Required = True
      Size = 30
    end
  end
  object dsTIP_CORP: TDataSource
    DataSet = oraTIP_CORP
    Left = 380
    Top = 32
  end
