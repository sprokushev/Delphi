...
type
  Tf_ZakazNew = class(TForm)
    ...
    GroupBox5: TGroupBox;
    Label36: TLabel;
    cbPeriodZakaz: TRxDBLookupCombo;
    oraPeriod: TOracleDataSet;
    dsPeriod: TDataSource;
    Label37: TLabel;
    cbTIP_CORP: TRxDBLookupCombo;
    oraTIP_CORP: TOracleDataSet;
    dsTIP_CORP: TDataSource;
    oraTIP_CORPID: TFloatField;
    oraTIP_CORPNAME: TStringField;
    oraVetkaID: TFloatField;
   ...
   10: // Новый заказ
       try
         EditID:=pkgFOR_ZAKAZ.CallFloatFunction('AddZakaz',[0,0,0,vIS_AGENT,StartOfTheMonth(edDatePlan.Date),edClientNum.Text,
                  ...
                  edPrim.Text,edGR4.Text,vZakazPrevId,cbGosprog.KeyValue,cbGpNapr.KeyValue,cbLukDog.KeyValue,LINK_ID,LINK_HIST_ID, cbPeriodZakaz.KeyValue, cbTIP_CORP.KeyValue]);
         oraTSes.Commit;
         ModalResult:=mrOk;
       except
...
begin
  ...
  cbVetka.KeyValue:=1;
  cbPeriodZakaz.KeyValue:=0;
  cbTIP_CORP.KeyValue:=1;
  ...
  Begin
    ...
    LINK_ID:=q_Source.FieldByName('LINK_ID').Asfloat;
    LINK_HIST_ID:=q_Source.FieldByName('LINK_HIST_ID').Asfloat;
    ...
    Begin
      ...
      vZakazPrevId:=q_Source.FieldByName('ZAKAZ_PREV_ID').Asfloat;
      cbPeriodZakaz.KeyValue:=q_Source.FieldByName('PERIOD_ID').AsInteger;
      cbTIP_CORP.KeyValue:=q_Source.FieldByName('TIP_CORP_ID').AsInteger;;
    end;
    ...
    cbVetka.KeyValue:=q_Source.FieldByName('VETKA_ID').AsFloat;
  ...
  case vSTATUS_ZAKAZ of
    ...
    40: begin
          ...
          Begin
            ...
            cbPeriodZakaz.Enabled:=false;
            cbTIP_CORP.Enabled:=false;
          end;
        end;
    50: begin
