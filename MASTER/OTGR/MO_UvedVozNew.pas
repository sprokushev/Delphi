...
type
  Tf_UvedVozNew = class(TForm)
    ...
    q_reestrP_VOD_KVIT: TFloatField;
    q_reestrP_DIRT_KVIT: TFloatField;
    q_reestrP_SOL_KVIT: TFloatField;
    q_reestrVES_NETTO_KVIT: TFloatField;
    q_reestrNUM_KVIT_TXT: TStringField;
