inherited f_Sved: Tf_Sved
  ...
  Width = 919
  Height = 647
  Caption = #1057#1042#1045#1044#1045#1053#1048#1071' '#1086#1073' '#1086#1090#1075#1088#1091#1079#1082#1077
  OnClose = FormClose
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object ActionManager1: TActionManager
    ...
    Top = 165
    StyleName = 'XP Style'
    object acMOSvedView: TAction
      Category = 'FOR_ALL'
      Caption = #1055#1088#1086#1089#1084#1086#1090#1088
      ImageIndex = 1
      OnExecute = acMOSvedViewExecute
    end
    object acMOSvedRowsView: TAction
      Category = 'FOR_ALL'
      Caption = #1055#1088#1086#1089#1084#1086#1090#1088' '#1074#1072#1075#1086#1085#1072
      ImageIndex = 1
      ShortCut = 115
      OnExecute = acMOSvedRowsViewExecute
    end
    ...
    object acMOSvedRowsCalc: TAction
      Category = 'ROWS'
      Caption = 'F9-'#1055#1077#1088#1077#1089#1095#1077#1090' '#1074#1077#1089#1072
      ImageIndex = 37
      ShortCut = 120
    ...
    object acMOSvedAddVagons: TAction
      Category = 'ROWS'
      Caption = #1048#1079' '#1074#1077#1076#1086#1084'.'#1087#1086#1076#1072#1095#1080
      ImageIndex = 20
      ShortCut = 16497
    ...
    object acMOSvedAddress: TAction
      Category = 'ROWS'
      Caption = #1055#1088#1080#1089#1074#1086#1080#1090#1100' '#1088#1072#1079#1088#1077#1096#1077#1085#1080#1077
      ImageIndex = 51
      OnExecute = acMOSvedAddressExecute
    end
    object acMOSvedNewNakl: TAction
      Category = 'ROWS'
      Caption = #1053#1086#1074#1072#1103' '#1085#1072#1082#1083#1072#1076#1085#1072#1103
      ImageIndex = 0
      OnExecute = acMOSvedNewNaklExecute
    end
    object acFindSved: TAction
      Category = 'FOR_ALL'
      Caption = 'F5-'#1055#1086#1080#1089#1082
      ImageIndex = 9
      ShortCut = 116
      OnExecute = acFindSvedExecute
    end
    object acMOUvedAdd: TAction
      Category = 'ROWS'
      Caption = #1053#1086#1074#1086#1077' '#1091#1074#1077#1076#1086#1084#1083#1077#1085#1080#1077
      ImageIndex = 0
      OnExecute = acMOUvedAddExecute
    end
  ...
  object q_title: TOracleDataSet
    SQL.Strings = (
      ...
      '  SOBSTV.SF_NAME as SOBSTV_NAME,'
        ...
        '  KLS_DOG.DOG_NUMBER, PLAT.SF_NAME as PLAT_NAME, PLAT.ID as PLAT' +
        '_ID,'
      ...
      '  FOR_SVED.GET_PASP_VALUE_AS_NUM(s.ID,NULL,'#39'MG_VOD'#39') AS MG_VOD'
      ...
      '  AND ((1=1'
        ...
        '/* '#1060#1080#1083#1100#1090#1088' '#1087#1086' '#1076#1072#1090#1077' */ AND s.SVED_DATE<=TO_DATE('#39'31.07.2005'#39','#39'dd.m' +
        'm.yyyy'#39')'
    ...
    Variables.Data = {
      ...
      000000000000090000003A5449544C455F4944050000000000000000000000}
    ...
    object q_titlePOLUCH_GD_KOD: TStringField
      DisplayLabel = #1043#1088#1091#1079#1086#1087#1086#1083#1091#1095#1072#1090#1077#1083#1100'|'#1046'/'#1076' '#1082#1086#1076
      FieldName = 'POLUCH_GD_KOD'
      Size = 12
    end
    ...
    object q_titlePLAT_ID: TIntegerField
      FieldName = 'PLAT_ID'
    end
    object q_titleMG_VOD: TFloatField
      DisplayLabel = #1057#1086#1076#1077#1088#1078#1072#1085#1080#1077' '#1074#1086#1076#1099', '#1084#1075'/'#1082#1075
      FieldName = 'MG_VOD'
    end
    object q_titleTEX_PD_ID: TFloatField
      FieldName = 'TEX_PD_ID'
    end
  end
  ...
  object q_rows: TOracleDataSet
    SQL.Strings = (
      ...
      'a.*,a.rowid,'
      '(CASE'
      '   WHEN b.VEDPOD_ROW_ID IS NULL THEN '#39#39
      
        '   ELSE TO_CHAR(c.VEDPOD_NUM)||'#39' '#1086#1090' '#39'||TO_CHAR(c.VEDPOD_DATE,'#39'dd' +
        '.mm.yyyy hh24:mi'#39')'
      ' END) as VED_POD_NUM,'
      '(CASE'
      '   WHEN rl.NARLINE_ID IS NULL THEN '#39#39
      
        '   ELSE TO_CHAR(r.NUM_NAR)||'#39' '#1086#1090' '#39'||TO_CHAR(r.DATE_NAR,'#39'dd.mm.yy' +
        'yy'#39')'
      ' END) as NARIAD_NUM,'
      '(CASE'
      ...
      'FROM REESTR a,'
        ...
        #9' (SELECT ID as VEDPOD_ROW_ID, VED_POD_ID as VEDPOD_ID FROM VED_' +
        'POD_ROW) b,'
      
        '   (SELECT ID as VEDPOD_ID, POD_NUM as VEDPOD_NUM, POD_DATE as V' +
        'EDPOD_DATE FROM VED_POD) c,'
      
        #9' (SELECT ID as NARLINE_ID, NARIAD_ID as NAR_ID FROM KLS_NAR_LIN' +
        'E) rl,'
      #9' (SELECT ID as NAR_ID, NUM_NAR, DATE_NAR FROM KLS_NARIAD) r,'
      #9' (SELECT ID as NAKL_ID,NAKL_NUM,NAKL_DATE FROM NAKL) n,'
      #9' (SELECT ID as UVED_ID,UVED_NUM,UVED_DATE FROM UVED) u'
      'WHERE a.SVED_ID=:SVED_ID'
      '  AND a.VED_POD_ROW_ID=b.VEDPOD_ROW_ID(+)'
      '  AND b.VEDPOD_ID=c.VEDPOD_ID(+)'
      '  AND a.NAR_LINE_ID=rl.NARLINE_ID(+)'
      '  AND rl.NAR_ID=r.NAR_ID(+)'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      31350100000000080000004E414B4C5F504F5301000000000700000055564544
      5F4944010000000008000000555645445F504F53010000000008000000555645
      445F4E554D01000000000700000049535F4155544F0100000000}
    UniqueFields = 'ID'
    Master = q_title
    MasterFields = 'ID'
    ...
    object q_rowsKOL_NET: TFloatField
      DisplayLabel = #1042#1077#1089' '#1053#1045#1058#1058#1054' ('#1085#1077#1092#1090#1080'), '#1090#1085
      FieldName = 'KOL_NET'
      Required = True
    end
    ...
    object q_rowsVOLUME15: TIntegerField
      DisplayLabel = #1054#1073#1098#1077#1084' '#1087#1088#1080' 15'#39'C'
      FieldName = 'VOLUME15'
      ReadOnly = True
      Required = True
    end
    ...
    object q_rowsUVED_NUM: TStringField
      DisplayLabel = #8470' '#1091#1074#1077#1076#1086#1084#1083#1077#1085#1080#1103' '#1086#1073' '#1091#1073#1086#1088#1082#1077
      FieldName = 'UVED_NUM'
      ReadOnly = True
      Size = 54
    end
    object q_rowsIS_AUTO: TIntegerField
      DisplayLabel = #1040#1074#1090'. '#1088#1072#1089#1095#1077#1090
      FieldName = 'IS_AUTO'
      ReadOnly = True
      Required = True
    end
  ...
  object q_Ved: TOracleDataSet
    SQL.Strings = (
      ...
      '  VED_POD.VETKA_OTP_ID /* ID '#1087#1091#1090#1080' '#1087#1086#1075#1088#1091#1079#1082#1080' */,'
        ...
        '  KLS_VETKA_OTP.VETKA_NAME||'#39', '#1042#1077#1076#1086#1084#1086#1089#1090#1100' '#8470' '#39'||TO_NCHAR(VED_POD.P' +
      ...
      '  VED_POD_ROW.POD_POS /* '#8470' '#1087'/'#1087' */,'
        ...
        '  TO_CHAR(VED_POD_ROW.POD_POS) || '#39') '#1074#1072#1075#1086#1085' '#39'||VED_POD_ROW.NUM_CI' +
        'ST || '#39' - '#39' || prod_v.ABBR_NPR as TreeChild1/*'#1042#1072#1075#1086#1085' '#1076#1083#1103' '#1087#1086#1089#1090#1088#1086#1077#1085 +
        #1080#1103' '#1076#1077#1088#1077#1074#1072'*/,'
      ...
      '  KLS_VAG_STATUS.NAME AS VAG_STATUS_NAME /* '#1057#1090#1072#1090#1091#1089' '#1074#1072#1075#1086#1085#1072' */,'
        ...
        '  KLS_VETKA_OTP.VETKA_NAME||'#39', '#1042#1077#1076#1086#1084#1086#1089#1090#1100' '#8470' '#39'||TO_NCHAR(VED_POD.P' +
        'OD_NUM)||'#39', '#39'||TO_CHAR(POD_DATE)||TO_CHAR(VED_POD_ROW.POD_POS) |' +
        '| '#39') '#1074#1072#1075#1086#1085' '#39'||VED_POD_ROW.NUM_CIST || '#39' - '#39' || prod_v.ABBR_NPR a' +
        's LookUp/*'#1082#1083#1102#1095' '#1076#1083#1103' '#1087#1086#1080#1089#1082#1072'*/'
      ...
      '  VED_POD.MESTO_ID=:MESTO_ID AND /* '#1084#1077#1089#1090#1086' '#1086#1090#1075#1088#1091#1079#1082#1080' */'
        ...
        'ORDER BY VED_POD.POD_DATE, VED_POD.POD_NUM, VED_POD_ROW.POD_POS,' +
        ' VED_POD_ROW.NUM_CIST')
    Variables.Data = {
  ...
  object q_NarLines: TOracleDataSet
    SQL.Strings = (
      ...
      '  KLS_NAR_LINE.NARIAD_ID, /* ID '#1085#1072#1088#1103#1076#1072' */'
      
        '  KLS_NAR_LINE.NOM_ZD||'#39', '#39'||TO_CHAR(KLS_NAR_LINE.KOL-KLS_NAR_LI' +
        'NE.FACT_KOL)||'#39' '#1074'/'#1094', '#39'||TO_CHAR(KLS_NAR_LINE.VES-KLS_NAR_LINE.FA' +
        'CT_VES)||'#39' '#1090#1085', '#39'||KLS_PROD.ABBR_NPR||'#39', '#39'||KLS_STAN.STAN_KOD||'#39' ' +
        #39'||KLS_STAN.STAN_NAME||'#39', '#39'||POLUCH.SHORT_NAME as TN,'
      '  KLS_NAR_LINE.ID as NAR_LINE_ID, /* ID '#1087#1086#1079#1080#1094#1080#1080' */'
      ...
      'SELECT distinct'
      '  NULL,'
      '  '#39#1056#1072#1079#1088#1077#1096#1077#1085#1080#1077' '#8470' '#39'||KLS_NARIAD.NUM_NAR as TN,'
      '  KLS_NAR_LINE.NARIAD_ID, /* ID '#1085#1072#1088#1103#1076#1072' */'
      '  null, /* '#8470' '#1088#1072#1079#1088#1077#1096#1077#1085#1080#1103' */'
  ...
  object mteNariad: TMemTableEh
    Params = <>
    DataDriver = dsdNariad
  ...
  object dsdNariad: TDataSetDriverEh
  ...
  object q_Gost: TOracleDataSet
    ...
    Left = 683
    Top = 449
    object q_GostID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object q_GostNAME: TStringField
      FieldName = 'NAME'
      Required = True
      Size = 50
    end
  end
  object ds_Gost: TDataSource
    DataSet = q_Gost
    Left = 676
    Top = 490
  end
