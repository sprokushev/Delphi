...
var
  ...
  vNN,vID,vRowID,vCardID:double;
  vNumOtgr,vFIO,vProd,vTime:string;
...
//try
  ...
  qSh30DBF.CommandTimeout:=30;
  qSh30DBF.SQL.Add('select ID,STATUS from '''+DstFromTable+''' where (ID=:KVIT_ID OR (STATUS>0 AND NP_DATA_O<:DATE_OTGR)) and NOT DELETED() and status<2 ORDER BY status');
  ...
  qUpdate.Parameters.Items[8].DataType:=ftFloat;
  ...
  qInsert.Parameters.Items[10].DataType:=ftFloat;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            qUpdate.Parameters.ParamByName('CARD_ID').Value:=vCardId;
            ...
            qUpdate.Parameters.ParamByName('KVIT_ID').Value:=qSh30DBF.FieldByName('ID').Value;
            qUpdate.ExecSQL;
        ...
        begin
          ...
          qInsert.Parameters.ParamByName('CARD_ID').Value:=vCardId;
